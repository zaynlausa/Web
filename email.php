      ...
      <div class="display-all">
        ...
        <div>
          <p class="mensahe" style="margin-bottom: 30px; margin-top: 16px; text-align:justify; margin-right: 80px;">
            ...
            For the security of your account and to ensure you receive all communication without interruption, we
            strongly advise you to update your email address in our system immediately if your current one is
            compromised or no longer in use.</p>
        </div>

        <div class="dis-name">
          <div class="title-display">Current Email Address</div>
          <div class="usr-email"><?php echo $email?></div>
        </div>
      </div>

      <div class="dis-name">
        <div class="title-display">New Email Address <span
            style="font-size: 12px;margin-left: 5px; color: #FE6128; font-weight:lighter;">REQUIRED</span></div>
        <!-- <div class="usr-email"> php echo $email </div> -->


        <form action="server/update.php" method="post" onsubmit="return validateEmail()">
          <div style="display: flex; flex-direction:column; margin:auto;">
            <input id="new-email" type="email" name="new-email" require>
